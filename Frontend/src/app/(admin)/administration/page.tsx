  ...
  const cards = [
    {
      ...
      title: "Категории",
      description:
        "Управление категориями услуг, добавление новых категорий и редактирование существующих.",
    ...
    },
    {
      ...
      title: "Услуги",
      description:
        "Просмотр и редактирование списка предоставляемых услуг, их описаний и характеристик.",
    ...
    },
    {
      ...
      title: "Рассписание",
      description:
        "Управление прайс-листом, установка и изменение стоимости услуг.",
    ...
    },
    {
      ...
      title: "Мастера",
      description:
        "Информация о сотрудниках, их специализация и контактные данные.",
    ...
    },
    {
      ...
      description:
        "Распределение услуг между мастерами, управление их специализациями.",
    ...
    },
    {
      ...
      title: "Записи",
      description:
        "График записей клиентов, управление расписанием и статусами записей.",
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {cards.map((card, index) => (
            ...
            >
              <div
                className={`h-32 ${card.gradient} flex items-center justify-center relative overflow-hidden`}
              >
